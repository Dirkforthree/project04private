...
Quoc Tinh La <quoctinh.la@stud.htw-dresden.de>; Vorname2 Nachname2 <email2@domain.org>; Vorname3 Nachname3 <email3@domain.org>
{localdatetime}
...
Das zu entwickelnde Präsentationssystem richtet sich an verschiedene Akteure innerhalb der "ZEISS Digital Innovation GmbH". Präsentatoren sollen effektive Präsentationen erstellen und steuern, während Zuhörer interaktiv auf Inhalte zugreifen können. Administratoren gewährleisten einen reibungslosen Betrieb und die Integrität des Systems. Diese Akteure spiegeln sich in verschiedenen Use Cases wider, die von der Erstellung und Vorführung von Präsentationen bis zur systematischen Pflege reichen.
// ...


== Identifizierte Use Cases
// Liste aller identifizierten Use Cases (priorisiert)
* *UC01*: Hochladen verschiedener Medien (Präsentator)
* *UC02*: Interagieren der Präsentation (Präsentator)
