...
NFA01: Licensing. Das System benötigt keine Lizensierung und soll eine freie Software sein. Diesbezüglich müssen die Nutzer der Software bestimmte Vereinbarungen zustimmen.
