...
=== ANF-09: Organisatorische Randbedingungen
...
**ANF-10:** Normen und Standards: Die Software sollte alle relevanten Normen und Standards einhalten, insbesondere diejenigen, die für Messeveranstaltungen oder den Umgang mit Medieninhalten gelten.

=== ANF-11: Rechtliche Anforderungen
