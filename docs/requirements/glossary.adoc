...
| Medium | Ist eine Datei zur Nutzung von Präsentationen | / | Formate wie mp4, Power Point, PDF, Word | / 
| Chapter (vorläufig) | Medium, welches als Präsentation in endlosschleife als auch in Kapiteln angezeigt werden kann | String | Verfügung über ein gültiges Medium | / 
| Chapters (vorläufig) | xx | xx | xx | xx 
| xx | xx | xx | xx | xx 
| xx | xx | xx | xx | xx 
| xx | xx | xx | xx | xx 
| xx | xx | xx | xx | xx 
