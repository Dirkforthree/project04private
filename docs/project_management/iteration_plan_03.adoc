...
siehe  *https://github.com/orgs/seproject04/projects/1/views/4[ Überblick  - Iteration 3]*
...
* nach Aufarbeitung des GitHub faupax ist Team nun wieder auf richtigem Kurs.  
