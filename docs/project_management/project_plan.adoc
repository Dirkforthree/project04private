...
Luca Jork lucathomas.jork@stud.htw-dresden.de; Vorname2 Nachname2 <email2@domain.org>; Vorname3 Nachname3 <email3@domain.org>
{localdatetime}
...
|===
|              | *Mail*                                             | *Rolle*                   |
| *Valine Richter* | valine.richter@stud.htw-dresden.de                | Analyse                   |
| *Merte Korpowski*| mertelaurentia.korpowski@stud.htw-dresden.de     | Implementeirung           |
| *Luca  Jork*     | lucathomas.jork@stud.htw-dresden.de               | Projektleiter             |
| *Maxim Zimmermann* | maxim.zimmermann@stud.htw-dresden.de             | Archtiekt/Implementirerung|
| *Florian Hausmann* | florian.hausmann@stud.htw-dresden.de             | Implementierung           |
| *Philipp Krickhuhn* | philipppascal.krickhuhn@stud.htw-dresden.de     | Analyse                   |
| *Quoc Tinh La*   | quoctinh.la@stud.htw-dresden.de                   | Analyse/Test              |
|===
